...
class RovWebrtcConn {
    peerServerConn = null;
    rovPeerId = "iROV-0"
    // ROV_PEERID_BASE = "SSROV_";
    // rovPeerIdEndNumber = 0; // the full rov peerid is the ROV_PEERID_BASE with this number tacked on the end
    ...
    connectToRov(closeupConnectionThen, reconnectCatch) {
        ...
        var rovPeerId = this.rovPeerId//this.ROV_PEERID_BASE + String(this.rovPeerIdEndNumber)
